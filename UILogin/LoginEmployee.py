...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(280, 100, 471, 491))
        font = QtGui.QFont()
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(80, 220, 311, 241))
        self.groupBox_2.setStyleSheet("background-color: rgb(191, 211, 182)\n"
"")
...
"")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:\\Users\\nguye\\PycharmProjects\\ktlt_final\\UILogin\\../images/enter (1).png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButtonLoginEmployee.setIcon(icon)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_5.setStyleSheet("background-color: rgb(0, 54, 0);\n"
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">Login</p></body></html>"))
