...
class Ui_BookingInformation(object):
    def setupUi(self, BookingInformation):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 190, 131, 251))
